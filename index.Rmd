...
```
The plot is available in the [Decision_Tree.png] file in the GitHub repository  (https://github.com/sreemoyee13/PracticalMachineLearning/blob/gh-pages/Decision%20_Tree.png)
