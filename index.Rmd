...
```
The Classification Tree plot by using the fancyRpartPlot()function is available in [FancyRplot_DecisionTree.pdf](https://github.com/sreemoyee13/PracticalMachineLearning/blob/gh-pages/FancyRplot_DecisionTree.pdf) file in the Github respiratory.
